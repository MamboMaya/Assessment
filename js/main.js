...
console.log(y) = undefined because it has yet to be defined in the function.
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) =  would be undefined because although it is declared, it has yet to be passed a value.
console.log(foo()) = "function hoisting" even though the function is called prior to the declaration, it will still run.
**************************************************************************************/
...
------------ ANSWER -------------------
inside add = 4
outside add = undefined

the IIFE doesnt allow the outside add have any value
**************************************************************************************/
